...
const DEFAULT_HERO = {
  badge: 'New: Minimal Testing Platform',
  title: 'Test smarter, ship faster with',
  titleHighlight: 'TestSite Pro',
  description:
    'Streamline your testing workflow with our minimal, powerful platform. Built for developers who value simplicity and speed.',
  features: ['Zero-config setup', 'Real-time results', 'CI/CD integration', 'Minimal overhead'],
  ...
  imageAlt: 'TestSite dashboard interface',
  statsLabel1: 'Test Speed',
  statsValue1: '3x Faster',
  statsLabel2: 'Setup Time',
  statsValue2: '< 2 minutes',
} as const;
